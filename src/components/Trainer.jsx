        ...
        <div className="tr-sidebar__bottom">
          <ul className="tr-sidebar__menu">
            <li onClick={() => navigate("/settings")}>
              <span className="tr-sidebar__icon"><IconSettings /></span>Settings
            </li>
      ...
      <div className="tr-main">
        ...
        <div className="tr-topbar">
          ...
          <div className="tr-topbar__right">
            ...
            <div className="tr-topbar__profile">
              <div className="tr-topbar__avatar">AD</div>
              <div className="tr-topbar__profile-info">
                <div className="tr-topbar__profile-name">Admin Staff</div>
        ...
        <div className="tr-content">
          ...
          <div className="tr-table-card">
            <div className="tr-table-header">
              ...
              <button className="tr-filter-btn"><IconFilter /> Filter & Sort</button>
            </div>
                      ...
                      <tr key={trainer.id} className="tr-row">
                        ...
                        <td>
                          <div className="tr-actions">
                            ...
                            <button className="tr-action-btn"                       title="More"><IconMoreVert /></button>
                          </div>
                        </td>
                      </tr>
                    ))
