...
const INITIAL_PROFILE = {
  ...
  dob:       "August 14, 1992",
  gender:    "Male",
  email:     "alex.thompson@fitpanel.com",
  phone:     "+1 (555) 123-4567",
  address:   "742 Evergreen Terrace, Springfield, IL 62704",
  status:    "Active",
  tier:      "Elite Member",
  plan:      "Elite Performance Plus",
  progress:  85,
  renewal:   42,
  sessions:  24,
  streak:    12,
        ...
        {done ? (
          ...
          <>
              ...
              {[
                ...
                <div className="mp-field" key={key}>
                  ...
                  <div className="mp-field__pw-wrap">
                    ...
                    />
                    <button className="mp-field__eye" onClick={() => toggle(key)}>
            ...
            <div className="mp-modal__footer">
              ...
              <button className="mp-modal__confirm" onClick={handleSave}>Update Password</button>
            </div>
          </>
        )}
      </div>
      ...
      <main className="mp-main">
        ...
        <header className="mp-topbar">
          ...
          <div className="mp-topbar__right">
            <button className="mp-notif">
              <IconBell />
              <span className="mp-notif__dot" />
            </button>
            <div className="mp-profile-top">
              <div className="mp-profile-top__avatar">AT</div>
              <span className="mp-profile-top__name">Alex Thompson</span>
