    ...
    const fetchPayments = async () => {
      try {
        ...
        const transformedPayments = payments.map(payment => ({
          id: payment.id || `PAY-${Math.random().toString(36).substr(2, 9).toUpperCase()}`,
          ...
          <div className="ph-summary">
            ...
            <div className="ph-summary-card ph-summary-card--brand">
              <div className="ph-summary-card__body">
                ...
                <div className="ph-summary-card__value">Rs {totalPaid.toLocaleString("en-US", { minimumFractionDigits: 2 })}</div>
            ...
            <div className="ph-summary-card">
              <div className="ph-summary-card__body">
                ...
                <div className="ph-summary-card__value">Rs 120.00</div>
                  ...
                  {paginated.length === 0 ? (
                    ...
                    paginated.map((t) => (
                      <tr key={t.id} className="ph-table__row">
                        ...
                        <td className="ph-table__amount">Rs {t.amount.toFixed(2)}</td>
