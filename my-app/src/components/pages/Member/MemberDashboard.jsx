...
const invoices = [
  { id: "INV-001", date: "Oct 01, 2023", amount: "Rs 85.00", status: "Paid"     },
  { id: "INV-002", date: "Nov 01, 2023", amount: "Rs 85.00", status: "Paid"     },
  { id: "INV-003", date: "Dec 01, 2023", amount: "Rs 85.00", status: "Upcoming" },
];
...
export default function MemberDashboard() {
  ...
  const welcomeName = (memberName || "").trim().split(/\s+/)[0] || "Member";

  const isActive = (route) => location.pathname === route;
  const handleNotificationClick = () => window.alert("No new notifications right now.");
  ...
  useEffect(() => {
    const fetchBookings = async () => {
      try {
        ...
        const res = await fetch(`${API_BASE_URL}/member/my-bookings`, {
    ...
    <div className="md-root">
      ...
      <aside className="ft-sidebar">
        ...
        <div className="ft-sidebar__brand">
          <div className="ft-sidebar__brand-icon"><IconDumbbellBrand /></div>
      ...
      <main className="md-main">
        ...
        <header className="md-topbar">
          ...
          <div className="md-topbar__right">
            ...
            <button className="md-notif" onClick={handleNotificationClick}>
              <IconBell />
              <span className="md-notif__dot" />
            </button>
            <div className="md-profile" onClick={() => navigate("/member/profile")}>
              <div className="md-profile__avatar">{memberInitials}</div>
              <span className="md-profile__name">{memberName}</span>
        ...
        <div className="md-content">
          ...
          <div className="md-welcome">
            <div>
              <h1 className="md-welcome__title">Welcome back, {welcomeName}!</h1>
          ...
          <div className="md-mid-row">
            ...
            <div className="md-session-card">
              ...
              <button className="md-reschedule-btn" onClick={() => navigate("/member/trainer")}>RESCHEDULE SESSION</button>
            </div>
          ...
          {!bookingsLoading && bookings.length > 0 && (
            <div className="md-booked-trainers">
              <div className="md-booked-trainers__header">
                <div>
                  <div className="md-booked-trainers__title">Booked Trainers</div>
                  <div className="md-booked-trainers__sub">Your upcoming training sessions</div>
                </div>
              </div>

              <div className="md-booked-trainers__list">
                {bookings.map((booking) => {
                  const trainerName = booking.trainer?.name || "Trainer";
                  const trainerSpec = booking.trainer?.specialization || "Personal Training";
                  ...
                  return (
                    <div key={booking.id} className="md-booked-trainer-card">
                      <div className="md-booked-trainer-avatar">{initials}</div>
                      <div className="md-booked-trainer-info">
                        <div className="md-booked-trainer-name">{trainerName}</div>
                        <div className="md-booked-trainer-spec">{trainerSpec}</div>
                      </div>
                      <div className="md-booked-trainer-details">
                        <div className="md-booked-trainer-date">
                          <IconCalendar />
                          <span>{formattedDate}</span>
                        </div>
                        <div className="md-booked-trainer-time">
                          <IconClock />
                          <span>{formattedTime}</span>
                        </div>
                      </div>
                      <div className={`md-booked-trainer-status md-booked-trainer-status--${booking.status}`}>
          ...
          <div className="md-bottom-row">
            ...
            <div className="md-payment-card">
                ...
                {invoices.map((inv) => (
                  <div key={inv.id} className="md-invoice">
                    <div className={`md-invoice__icon ${inv.status === "Upcoming" ? "md-invoice__icon--upcoming" : "md-invoice__icon--paid"}`}>
                      {inv.status === "Upcoming" ? "Rs" : <IconCheck />}
                    </div>
              ...
              <button className="md-view-ledger" onClick={() => navigate("/member/payments")}>
