        ...
        <div className="ft-modal__body">
          ...
          <div className="ft-form-group">
            ...
            <select name="plan" value={form.plan} onChange={handleChange}>
              <option value="Premium">Premium — Rs 199/yr</option>
              <option value="Standard">Standard — Rs 99/3mo</option>
              <option value="Basic">Basic — Rs 49/mo</option>
            </select>
          </div>
          <div className="ft-form-group">
            <label>Status</label>
...
const AdminDashboard = () => {
  ...
  const monthlyRevenue = "Rs 67,420";

  const normalizedSearch = search.trim().toLowerCase();
  const filtered = members.filter((m) => {
    if (!normalizedSearch) return true;
    const searchable = [m.name, m.email, m.plan, m.status, m.date]
      .filter(Boolean)
      .join(" ")
      .toLowerCase();
        ...
        <div className="ft-topbar">
          ...
          <div className="ft-topbar__right">
            ...
            <div className="ft-profile" onClick={() => navigate("/admin/profile")} style={{ cursor: "pointer" }}>
              <div className="ft-profile__avatar">{adminInitials}</div>
              <div className="ft-profile__info">
                <div className="ft-profile__name">{adminName}</div>
